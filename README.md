...
1）把/output/bin/目录下的 Qsahara fh_loader拷贝到 /usr/bin/目录下，并且修改权限为 777 ，例如chmod 777 /usr/bin/Qsahara   chmod 777 /usr/bin/fh_loader
...
3）终端 进入高通大版本编译完成的下载镜像目录下，及bin_for_dl目录下：
在终端下运行 fh53
